...
const GlobalIdentifierModelBase = require("divbloxjs/dx-orm/generated/models/global-identifier.model-base");

/**
 * An object model class used to describe the entity GlobalIdentifier in an OOP manner
 */
class GlobalIdentifierModel extends GlobalIdentifierModelBase {
    /**
     * Basic initialization for the globalIdentifier object model class.
     ...
     */
    constructor(dxInstance, entityName = "globalIdentifier", globalIdentifier = "") {
        super(dxInstance, entityName, globalIdentifier);
    }
}

module.exports = GlobalIdentifierModel;
