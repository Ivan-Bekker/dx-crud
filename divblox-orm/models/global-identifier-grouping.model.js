...
const GlobalIdentifierGroupingModelBase = require("divbloxjs/dx-orm/generated/models/global-identifier-grouping.model-base");

/**
 * An object model class used to describe the entity GlobalIdentifierGrouping in an OOP manner
 */
class GlobalIdentifierGroupingModel extends GlobalIdentifierGroupingModelBase {
    /**
     * Basic initialization for the globalIdentifierGrouping object model class.
     ...
     */
    constructor(dxInstance, entityName = "globalIdentifierGrouping", globalIdentifier = "") {
        super(dxInstance, entityName, globalIdentifier);
    }
}

module.exports = GlobalIdentifierGroupingModel;
